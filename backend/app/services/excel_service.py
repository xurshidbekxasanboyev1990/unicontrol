...
class ExcelService:
    ...
    _KNOWN_SUBJECTS = [
        ...
        "o'zbek tili", "oʻzbek tili", "o`zbek tili",
        ...
        "oʻzbekistonning eng yangi tarixi", "o'zbekistonning eng yangi tarixi",
        "o'zbekiston tarixi", "oʻzbekiston tarixi",
        ...
        "tibbiy biofizika", "tibbiy biofizika asoslari",
        "milliy istiqlol g'oyasi", "milliy g'oya",
        "harbiy tayyorgarlik", "jismoniy tarbiya",
        "ommaviy axborot vositalari", "sotsiologiya",
        "inson anatomiyasi", "topografik anatomiya",
        "operativ jarrohlik", "propedevtika",
        "tibbiyot huquqi", "sog'liqni saqlash",
        "reanimatologiya", "anesteziologiya",
        "onkologiya", "ftiziatriya", "radiologiya",
        "travmatologiya", "ortopediya", "urologiya",
        "endokrinologiya", "kardiologiya", "pulmonologiya",
        "nefrologiya", "gastroenterologiya", "gematologiya",
        "tarbiyaviy soat", "tarbiyaviy ish",
    ]
