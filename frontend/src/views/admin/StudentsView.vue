<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-slate-800">Talabalar boshqaruvi</h1>
        <p class="text-slate-500">{{ filteredStudents.length }} ta talaba</p>
      </div>
      <div class="flex items-center gap-3">
        <div class="relative">
          ...
          <input 
            ...
            class="pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 outline-none w-64"
          />
        </div>
